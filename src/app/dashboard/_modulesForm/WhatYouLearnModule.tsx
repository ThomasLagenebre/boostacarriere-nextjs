...
export default function WhatYouLearnModule({whatYouLearn}: {whatYouLearn?: WhatYouLearn[]}) {
    ...
    return (
        <DashboardSection>
            <h4 className='font-bold underline text-secondary mb-4'>Section : que vas-tu apprendre ?</h4>
            <div className='my-4'>
                <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Ce que tu vas apprendre <span className='italic text-xs font-normal'>(clique sur le + pour ajouter une autre ligne)</span>
                </label>
