  ...
  return (
    <footer className='bg-secondary py-4 px-4 xl:py-10 mt-6'>
        ...
        <div className="sm:flex sm:items-center sm:justify-between max-w-screen-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center mt-4 space-y-2 sm:space-y-0 sm:space-x-6 sm:justify-center">
                {/* Liens légaux */}
                <div className="flex items-center space-x-4 text-xs text-light">
                    <Link href="/mentions-legales" className="hover:underline hover:text-gray-200 transition-colors duration-300">
                        Mentions légales
                    </Link>
                    <span className="text-gray-400">•</span>
                    <Link href="/cgv" className="hover:underline hover:text-gray-200 transition-colors duration-300">
                        CGV
                    </Link>
                    <span className="text-gray-400">•</span>
                    <Link href="/faq" className="hover:underline hover:text-gray-200 transition-colors duration-300">
                        FAQ
                    </Link>
                </div>
                {/* Réseaux sociaux */}
                <div className="flex items-center space-x-6">
                    ...
                    <a href="https://www.linkedin.com/in/laurine-lagenebre-8720a3307/" rel="noreferrer" target="blank" className="text-light hover:text-gray-900 dark:hover:text-white"><FaLinkedinIn className='w-5 h-5'/></a>
                </div>
            </div>
        </div>
    </footer>
